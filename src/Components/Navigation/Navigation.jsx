...
export default function Navigation() {
  ...
  return (
    ...
    >
      <nav
        id="nav"
        className="relative flex flex-row bg-transparent   w-full h-fit justify-between px-[2rem] lg:px-[4rem] items-center z-50 "
      >
        <div className="relative bg-transparent pr-4 md:pd-0 w-fit h-fit z-50">
          <motion.div
            initial={{
              color: "white",
